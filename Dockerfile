...
ADD bin/setup /usr/local/bin/setup/1517140956
ADD bin/config /usr/local/bin/config/1517140956

RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1517140956 
...
LABEL \
    org.label-schema.vcs-ref=1805b39 \
