...
ADD bin/setup /usr/local/bin/setup/1517140858
ADD bin/config /usr/local/bin/config/1517140858

RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1517140858 
...
LABEL \
    org.label-schema.vcs-ref=8052bb7 \
