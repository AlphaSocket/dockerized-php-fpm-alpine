...
ADD imports/bin/setup /usr/local/bin/setup/1518963391
ADD imports/bin/config /usr/local/bin/config/1518963391


RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1518963391 1>/dev/stdout 2>/dev/stderr
