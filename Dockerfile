...
ADD bin/setup /usr/local/bin/setup/1517140888
ADD bin/config /usr/local/bin/config/1517140888

RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1517140888 
...
LABEL \
    org.label-schema.vcs-ref=7d32b85 \
