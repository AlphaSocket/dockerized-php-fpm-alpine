...
ADD bin/setup /usr/local/bin/setup/1517140839
ADD bin/config /usr/local/bin/config/1517140839

RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1517140839 
...
LABEL \
    org.label-schema.vcs-ref=29898fa \
