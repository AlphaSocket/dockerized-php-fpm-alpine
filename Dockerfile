...
ADD bin/setup /usr/local/bin/setup/1517140841
ADD bin/config /usr/local/bin/config/1517140841

RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1517140841 
...
LABEL \
    org.label-schema.vcs-ref=cd8099b \
