...
ADD bin/setup /usr/local/bin/setup/1518035747
ADD bin/config /usr/local/bin/config/1518035747


RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1518035747 1>/dev/stdout 2>/dev/stderr
...
LABEL \
    org.label-schema.vcs-ref=230afb5 \
