...
ADD bin/setup /usr/local/bin/setup/1516964386
ADD bin/config /usr/local/bin/config/1516964386

RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1516964386 
...
LABEL \
    org.label-schema.vcs-ref=0928f8f \
