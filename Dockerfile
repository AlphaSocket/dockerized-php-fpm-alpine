...
ADD bin/setup /usr/local/bin/setup/1517140780
ADD bin/config /usr/local/bin/config/1517140780

RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1517140780 
...
LABEL \
    org.label-schema.vcs-ref=2dddd68 \
