...
ADD bin/setup /usr/local/bin/setup/1517140933
ADD bin/config /usr/local/bin/config/1517140933

RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1517140933 
...
LABEL \
    org.label-schema.vcs-ref=90c5d2b \
