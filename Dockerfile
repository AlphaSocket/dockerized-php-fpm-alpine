...
ADD bin/setup /usr/local/bin/setup/1517140725
ADD bin/config /usr/local/bin/config/1517140725

RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1517140725 
...
LABEL \
    org.label-schema.vcs-ref=8d72afd \
