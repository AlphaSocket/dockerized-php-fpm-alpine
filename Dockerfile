...
ADD bin/setup /usr/local/bin/setup/1517140913
ADD bin/config /usr/local/bin/config/1517140913

RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1517140913 
...
LABEL \
    org.label-schema.vcs-ref=fe44abc \
