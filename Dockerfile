...
ADD bin/setup /usr/local/bin/setup/1517140851
ADD bin/config /usr/local/bin/config/1517140851

RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1517140851 
...
LABEL \
    org.label-schema.vcs-ref=288cb62 \
