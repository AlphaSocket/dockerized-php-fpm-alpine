...
ADD bin/setup /usr/local/bin/setup/1517140771
ADD bin/config /usr/local/bin/config/1517140771

RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1517140771 
...
LABEL \
    org.label-schema.vcs-ref=a583fc3 \
