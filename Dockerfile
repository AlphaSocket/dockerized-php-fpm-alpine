...
ADD bin/setup /usr/local/bin/setup/1517140893
ADD bin/config /usr/local/bin/config/1517140893

RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1517140893 
...
LABEL \
    org.label-schema.vcs-ref=5258e2b \
