...
ADD bin/setup /usr/local/bin/setup/1517140865
ADD bin/config /usr/local/bin/config/1517140865

RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1517140865 
...
LABEL \
    org.label-schema.vcs-ref=2fd0fd9 \
