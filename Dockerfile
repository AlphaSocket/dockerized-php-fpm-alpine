...
ADD bin/setup /usr/local/bin/setup/1516964391
ADD bin/config /usr/local/bin/config/1516964391

RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1516964391 
...
LABEL \
    org.label-schema.vcs-ref=8b9bdb8 \
