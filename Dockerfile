...
ADD imports/bin/setup /usr/local/bin/setup/1519336284
ADD imports/bin/config /usr/local/bin/config/1519336284
ADD imports/templates/pool.conf /usr/local/templates/pool.conf


RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1519336284 1>/dev/stdout 2>/dev/stderr
