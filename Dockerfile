...
ADD bin/setup /usr/local/bin/setup/1517140946
ADD bin/config /usr/local/bin/config/1517140946

RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1517140946 
...
LABEL \
    org.label-schema.vcs-ref=7ca79bd \
