...
ADD bin/setup /usr/local/bin/setup/1517140616
ADD bin/config /usr/local/bin/config/1517140616

RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1517140616 
...
LABEL \
    org.label-schema.vcs-ref=8c53883 \
