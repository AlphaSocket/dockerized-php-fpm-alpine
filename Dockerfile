...
ADD bin/setup /usr/local/bin/setup/1516981857
ADD bin/config /usr/local/bin/config/1516981857

RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1516981857 
...
LABEL \
    org.label-schema.vcs-ref=58219c0 \
