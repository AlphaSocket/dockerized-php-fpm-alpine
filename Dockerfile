...
ADD bin/setup /usr/local/bin/setup/1517140918
ADD bin/config /usr/local/bin/config/1517140918

RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1517140918 
...
LABEL \
    org.label-schema.vcs-ref=f6667e6 \
