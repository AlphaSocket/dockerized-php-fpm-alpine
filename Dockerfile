...
ADD bin/setup /usr/local/bin/setup/1516964383
ADD bin/config /usr/local/bin/config/1516964383

RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1516964383 
...
LABEL \
    org.label-schema.vcs-ref=6e68ebd \
