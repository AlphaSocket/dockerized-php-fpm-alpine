...
ADD bin/setup /usr/local/bin/setup/1517140881
ADD bin/config /usr/local/bin/config/1517140881

RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1517140881 
...
LABEL \
    org.label-schema.vcs-ref=b15cd22 \
