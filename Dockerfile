...
ADD bin/setup /usr/local/bin/setup/1517140920
ADD bin/config /usr/local/bin/config/1517140920

RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1517140920 
...
LABEL \
    org.label-schema.vcs-ref=037a2d0 \
