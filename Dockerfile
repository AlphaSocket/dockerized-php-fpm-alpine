...
ADD bin/setup /usr/local/bin/setup/1517140750
ADD bin/config /usr/local/bin/config/1517140750

RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1517140750 
...
LABEL \
    org.label-schema.vcs-ref=71ba9d7 \
