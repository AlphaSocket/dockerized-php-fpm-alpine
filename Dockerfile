...
ADD bin/setup /usr/local/bin/setup/1516981866
ADD bin/config /usr/local/bin/config/1516981866

RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1516981866 
...
LABEL \
    org.label-schema.vcs-ref=975aeb5 \
