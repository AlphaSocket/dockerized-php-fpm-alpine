...
ADD bin/setup /usr/local/bin/setup/1517140891
ADD bin/config /usr/local/bin/config/1517140891

RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1517140891 
...
LABEL \
    org.label-schema.vcs-ref=05a125e \
