...
ADD bin/setup /usr/local/bin/setup/1517140848
ADD bin/config /usr/local/bin/config/1517140848

RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1517140848 
...
LABEL \
    org.label-schema.vcs-ref=4ad0ee6 \
