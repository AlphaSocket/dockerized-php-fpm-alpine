...
ADD bin/setup /usr/local/bin/setup/1517140953
ADD bin/config /usr/local/bin/config/1517140953

RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1517140953 
...
LABEL \
    org.label-schema.vcs-ref=8260755 \
