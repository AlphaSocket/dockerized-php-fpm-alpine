...
ADD bin/setup /usr/local/bin/setup/1517140927
ADD bin/config /usr/local/bin/config/1517140927

RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1517140927 
...
LABEL \
    org.label-schema.vcs-ref=bc2c65b \
