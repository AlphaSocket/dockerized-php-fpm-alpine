...
ADD bin/setup /usr/local/bin/setup/1517140941
ADD bin/config /usr/local/bin/config/1517140941

RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1517140941 
...
LABEL \
    org.label-schema.vcs-ref=8987cfd \
