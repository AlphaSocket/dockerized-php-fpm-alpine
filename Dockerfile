...
ADD imports/bin/setup /usr/local/bin/setup/1518822727
ADD imports/bin/config /usr/local/bin/config/1518822727


RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1518822727 1>/dev/stdout 2>/dev/stderr
