...
ADD bin/setup /usr/local/bin/setup/1517140836
ADD bin/config /usr/local/bin/config/1517140836

RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1517140836 
...
LABEL \
    org.label-schema.vcs-ref=27181d9 \
