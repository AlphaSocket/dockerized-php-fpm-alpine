...
ADD bin/setup /usr/local/bin/setup/1517140906
ADD bin/config /usr/local/bin/config/1517140906

RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1517140906 
...
LABEL \
    org.label-schema.vcs-ref=8b5b4e1 \
