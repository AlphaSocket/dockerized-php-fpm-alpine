...
ADD bin/setup /usr/local/bin/setup/1517140846
ADD bin/config /usr/local/bin/config/1517140846

RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1517140846 
...
LABEL \
    org.label-schema.vcs-ref=2683991 \
