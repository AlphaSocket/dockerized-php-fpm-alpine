...
ADD bin/setup /usr/local/bin/setup/1517140872
ADD bin/config /usr/local/bin/config/1517140872

RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1517140872 
...
LABEL \
    org.label-schema.vcs-ref=a0c72da \
