...
ADD bin/setup /usr/local/bin/setup/1516964388
ADD bin/config /usr/local/bin/config/1516964388

RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1516964388 
...
LABEL \
    org.label-schema.vcs-ref=6559ace \
