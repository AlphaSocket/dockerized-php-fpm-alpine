...
ADD bin/setup /usr/local/bin/setup/1517140796
ADD bin/config /usr/local/bin/config/1517140796

RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1517140796 
...
LABEL \
    org.label-schema.vcs-ref=e92ab21 \
