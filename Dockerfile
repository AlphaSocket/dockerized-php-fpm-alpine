...
ADD bin/setup /usr/local/bin/setup/1516981854
ADD bin/config /usr/local/bin/config/1516981854

RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1516981854 
...
LABEL \
    org.label-schema.vcs-ref=64d9f58 \
