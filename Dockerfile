...
ADD bin/setup /usr/local/bin/setup/1517140943
ADD bin/config /usr/local/bin/config/1517140943

RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1517140943 
...
LABEL \
    org.label-schema.vcs-ref=925cc14 \
