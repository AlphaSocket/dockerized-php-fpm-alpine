...
ADD bin/setup /usr/local/bin/setup/1517140911
ADD bin/config /usr/local/bin/config/1517140911

RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1517140911 
...
LABEL \
    org.label-schema.vcs-ref=294dec2 \
