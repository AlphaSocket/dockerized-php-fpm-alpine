...
ADD bin/setup /usr/local/bin/setup/1517140787
ADD bin/config /usr/local/bin/config/1517140787

RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1517140787 
...
LABEL \
    org.label-schema.vcs-ref=de6c07e \
