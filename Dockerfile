...
ADD bin/setup /usr/local/bin/setup/1516964397
ADD bin/config /usr/local/bin/config/1516964397

RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1516964397 
...
LABEL \
    org.label-schema.vcs-ref=28390a3 \
