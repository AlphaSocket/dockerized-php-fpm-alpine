...
ADD bin/setup /usr/local/bin/setup/1516981846
ADD bin/config /usr/local/bin/config/1516981846

RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1516981846 
...
LABEL \
    org.label-schema.vcs-ref=10a996b \
