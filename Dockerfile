...
ADD bin/setup /usr/local/bin/setup/1517140778
ADD bin/config /usr/local/bin/config/1517140778

RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1517140778 
...
LABEL \
    org.label-schema.vcs-ref=349f319 \
