...
ADD bin/setup /usr/local/bin/setup/1517140870
ADD bin/config /usr/local/bin/config/1517140870

RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1517140870 
...
LABEL \
    org.label-schema.vcs-ref=a03489a \
