...
ADD imports/bin/setup /usr/local/bin/setup/1518868510
ADD imports/bin/config /usr/local/bin/config/1518868510


RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1518868510 1>/dev/stdout 2>/dev/stderr
