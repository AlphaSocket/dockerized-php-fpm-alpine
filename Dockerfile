...
ADD bin/setup /usr/local/bin/setup/1516981851
ADD bin/config /usr/local/bin/config/1516981851

RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1516981851 
...
LABEL \
    org.label-schema.vcs-ref=640b816 \
