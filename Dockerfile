...
ADD bin/setup /usr/local/bin/setup/1517140782
ADD bin/config /usr/local/bin/config/1517140782

RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1517140782 
...
LABEL \
    org.label-schema.vcs-ref=7b458f1 \
