...
ADD bin/setup /usr/local/bin/setup/1517140856
ADD bin/config /usr/local/bin/config/1517140856

RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1517140856 
...
LABEL \
    org.label-schema.vcs-ref=5cb991d \
