...
ADD bin/setup /usr/local/bin/setup/1517140936
ADD bin/config /usr/local/bin/config/1517140936

RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1517140936 
...
LABEL \
    org.label-schema.vcs-ref=f40d530 \
