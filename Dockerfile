...
ADD bin/setup /usr/local/bin/setup/1517140767
ADD bin/config /usr/local/bin/config/1517140767

RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1517140767 
...
LABEL \
    org.label-schema.vcs-ref=bbbf220 \
