...
ADD imports/bin/setup /usr/local/bin/setup/1519169315
ADD imports/bin/config /usr/local/bin/config/1519169315
ADD imports/templates/pool.conf /usr/local/templates/pool.conf


RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1519169315 1>/dev/stdout 2>/dev/stderr
