...
ADD bin/setup /usr/local/bin/setup/1517140958
ADD bin/config /usr/local/bin/config/1517140958

RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1517140958 
...
LABEL \
    org.label-schema.vcs-ref=6c9f424 \
