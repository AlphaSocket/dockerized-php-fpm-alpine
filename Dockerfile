...
ADD bin/setup /usr/local/bin/setup/1516964393
ADD bin/config /usr/local/bin/config/1516964393

RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1516964393 
...
LABEL \
    org.label-schema.vcs-ref=b7d87b1 \
