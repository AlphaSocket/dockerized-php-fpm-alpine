...
ADD bin/setup /usr/local/bin/setup/1517140915
ADD bin/config /usr/local/bin/config/1517140915

RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1517140915 
...
LABEL \
    org.label-schema.vcs-ref=820f9a8 \
