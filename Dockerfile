...
ADD bin/setup /usr/local/bin/setup/1517140901
ADD bin/config /usr/local/bin/config/1517140901

RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1517140901 
...
LABEL \
    org.label-schema.vcs-ref=d3f64c5 \
