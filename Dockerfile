...
ADD bin/setup /usr/local/bin/setup/1517140898
ADD bin/config /usr/local/bin/config/1517140898

RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1517140898 
...
LABEL \
    org.label-schema.vcs-ref=79cc851 \
