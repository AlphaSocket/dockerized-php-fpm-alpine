...
ADD bin/setup /usr/local/bin/setup/1517140748
ADD bin/config /usr/local/bin/config/1517140748

RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1517140748 
...
LABEL \
    org.label-schema.vcs-ref=b878ac5 \
