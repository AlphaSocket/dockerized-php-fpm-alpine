...
ADD bin/setup /usr/local/bin/setup/1517140843
ADD bin/config /usr/local/bin/config/1517140843

RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1517140843 
...
LABEL \
    org.label-schema.vcs-ref=15114ea \
