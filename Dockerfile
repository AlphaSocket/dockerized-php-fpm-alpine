...
ADD bin/setup /usr/local/bin/setup/1517140769
ADD bin/config /usr/local/bin/config/1517140769

RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1517140769 
...
LABEL \
    org.label-schema.vcs-ref=5b05c79 \
