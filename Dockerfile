...
ADD bin/setup /usr/local/bin/setup/1517140574
ADD bin/config /usr/local/bin/config/1517140574

RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1517140574 
...
LABEL \
    org.label-schema.vcs-ref=dddcf09 \
