...
ADD bin/setup /usr/local/bin/setup/1517140802
ADD bin/config /usr/local/bin/config/1517140802

RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1517140802 
...
LABEL \
    org.label-schema.vcs-ref=619c6ac \
