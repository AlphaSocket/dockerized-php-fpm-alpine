...
ADD bin/setup /usr/local/bin/setup/1517140867
ADD bin/config /usr/local/bin/config/1517140867

RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1517140867 
...
LABEL \
    org.label-schema.vcs-ref=f9d6e64 \
