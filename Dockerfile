...
ADD bin/setup /usr/local/bin/setup/1517140764
ADD bin/config /usr/local/bin/config/1517140764

RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1517140764 
...
LABEL \
    org.label-schema.vcs-ref=a07c7c7 \
