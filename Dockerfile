...
ADD bin/setup /usr/local/bin/setup/1517140883
ADD bin/config /usr/local/bin/config/1517140883

RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1517140883 
...
LABEL \
    org.label-schema.vcs-ref=eeac224 \
