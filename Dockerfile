...
ADD bin/setup /usr/local/bin/setup/1517140886
ADD bin/config /usr/local/bin/config/1517140886

RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1517140886 
...
LABEL \
    org.label-schema.vcs-ref=41da03b \
