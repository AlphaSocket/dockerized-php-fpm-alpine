...
ADD bin/setup /usr/local/bin/setup/1517140929
ADD bin/config /usr/local/bin/config/1517140929

RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1517140929 
...
LABEL \
    org.label-schema.vcs-ref=f5e3dd7 \
