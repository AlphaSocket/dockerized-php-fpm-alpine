...
ADD bin/setup /usr/local/bin/setup/1517140908
ADD bin/config /usr/local/bin/config/1517140908

RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1517140908 
...
LABEL \
    org.label-schema.vcs-ref=0666ad4 \
