...
ADD bin/setup /usr/local/bin/setup/1517140948
ADD bin/config /usr/local/bin/config/1517140948

RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1517140948 
...
LABEL \
    org.label-schema.vcs-ref=4657af2 \
