...
ADD bin/setup /usr/local/bin/setup/1517140896
ADD bin/config /usr/local/bin/config/1517140896

RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1517140896 
...
LABEL \
    org.label-schema.vcs-ref=4b6be7c \
