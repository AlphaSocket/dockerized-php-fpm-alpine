...
ADD bin/setup /usr/local/bin/setup/1517140874
ADD bin/config /usr/local/bin/config/1517140874

RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1517140874 
...
LABEL \
    org.label-schema.vcs-ref=5be5eeb \
