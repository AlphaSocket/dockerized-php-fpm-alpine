...
ADD bin/setup /usr/local/bin/setup/1517140860
ADD bin/config /usr/local/bin/config/1517140860

RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1517140860 
...
LABEL \
    org.label-schema.vcs-ref=d3d165c \
