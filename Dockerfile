...
ADD bin/setup /usr/local/bin/setup/1516981843
ADD bin/config /usr/local/bin/config/1516981843

RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1516981843 
...
LABEL \
    org.label-schema.vcs-ref=68b4385 \
